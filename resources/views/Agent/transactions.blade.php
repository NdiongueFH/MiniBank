...
<div class="container mt-5">
    ...
    @foreach ($transactions as $transaction)
        <tr>
            ...
            <td>{{ $distributeur ? $distributeur->nom : 'N/A' }}</td>
            <td>{{ $distributeur ? $distributeur->prenom : 'N/A' }}</td>
            <td>{{ $distributeur ? $distributeur->adresse : 'N/A' }}</td>
            <td>{{ $distributeur ? $distributeur->num_compte : 'N/A' }}</td>
            <td>{{ $distributeur ? $distributeur->carte_identite : 'N/A' }}</td>
            <td>
